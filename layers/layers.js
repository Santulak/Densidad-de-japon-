...
var lyr_DensidadPrefecturahabKm2_2 = new ol.layer.Vector({
    ...
    <img src="styles/legend/DensidadPrefecturahabKm2_2_1.png" /> 191 - 354<br />\
    <img src="styles/legend/DensidadPrefecturahabKm2_2_2.png" /> 355 - 643<br />\
    <img src="styles/legend/DensidadPrefecturahabKm2_2_3.png" /> 643 - 1214<br />\
    <img src="styles/legend/DensidadPrefecturahabKm2_2_4.png" /> 1215 - 1931<br />\
    <img src="styles/legend/DensidadPrefecturahabKm2_2_5.png" /> 1932 - 4607<br />\
    <img src="styles/legend/DensidadPrefecturahabKm2_2_6.png" /> 4608 - 6454<br />'
        });
...
var lyr_DensidadDistritohabKm2_3 = new ol.layer.Vector({
    ...
    <img src="styles/legend/DensidadDistritohabKm2_3_1.png" /> 1001 - 2013<br />\
    <img src="styles/legend/DensidadDistritohabKm2_3_2.png" /> 2014 - 4118<br />\
    <img src="styles/legend/DensidadDistritohabKm2_3_3.png" /> 4119 - 6817<br />\
    <img src="styles/legend/DensidadDistritohabKm2_3_4.png" /> 6818 - 10425<br />\
    <img src="styles/legend/DensidadDistritohabKm2_3_5.png" /> 10426 - 15651<br />\
    <img src="styles/legend/DensidadDistritohabKm2_3_6.png" /> 15652 - 23150<br />'
        });
...
var format_Rutas_7 = new ol.format.GeoJSON();
var features_Rutas_7 = format_Rutas_7.readFeatures(json_Rutas_7, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Rutas_7 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Rutas_7.addFeatures(features_Rutas_7);
var lyr_Rutas_7 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Rutas_7, 
                style: style_Rutas_7,
                popuplayertitle: "Rutas",
                interactive: true,
                title: '<img src="styles/legend/Rutas_7.png" /> Rutas'
            });
...
lyr_ESRIGraylight_0.setVisible(true);lyr_Region_1.setVisible(true);lyr_DensidadPrefecturahabKm2_2.setVisible(true);lyr_DensidadDistritohabKm2_3.setVisible(true);lyr_Lagos_4.setVisible(true);lyr_Rios_5.setVisible(true);lyr_Ferrocarril_6.setVisible(true);lyr_Rutas_7.setVisible(true);lyr_CiudadCapital_8.setVisible(true);
var layersList = [lyr_ESRIGraylight_0,lyr_Region_1,lyr_DensidadPrefecturahabKm2_2,lyr_DensidadDistritohabKm2_3,lyr_Lagos_4,lyr_Rios_5,lyr_Ferrocarril_6,lyr_Rutas_7,lyr_CiudadCapital_8];
...
lyr_Lagos_4.set('fieldAliases', {'Nombre': 'Nombre', 'Tipo': 'Tipo', });
lyr_Rios_5.set('fieldAliases', {'Nombre': 'Nombre', 'Categoria': 'Categoria', });
lyr_Ferrocarril_6.set('fieldAliases', {'fid': 'fid', '名前': '名前', 'Nombre': 'Nombre', 'Tipo': 'Tipo', });
lyr_Rutas_7.set('fieldAliases', {'fid': 'fid', '名前': '名前', 'Nombre': 'Nombre', });
lyr_CiudadCapital_8.set('fieldAliases', {'Nombre': 'Nombre', '名前': '名前', });
lyr_Region_1.set('fieldImages', {'Nombre': 'TextEdit', '地域': 'TextEdit', });
lyr_DensidadPrefecturahabKm2_2.set('fieldImages', {'Nombre': 'TextEdit', '名前': 'TextEdit', 'Poblacion': 'TextEdit', 'Area': 'TextEdit', 'Densidad': 'TextEdit', 'Region': 'TextEdit', '地域': 'TextEdit', });
...
lyr_Lagos_4.set('fieldImages', {'Nombre': 'TextEdit', 'Tipo': 'TextEdit', });
lyr_Rios_5.set('fieldImages', {'Nombre': 'TextEdit', 'Categoria': 'TextEdit', });
lyr_Ferrocarril_6.set('fieldImages', {'fid': 'TextEdit', '名前': 'TextEdit', 'Nombre': 'TextEdit', 'Tipo': '', });
lyr_Rutas_7.set('fieldImages', {'fid': 'TextEdit', '名前': 'TextEdit', 'Nombre': 'TextEdit', });
...
lyr_Lagos_4.set('fieldLabels', {'Nombre': 'inline label - always visible', 'Tipo': 'inline label - always visible', });
lyr_Rios_5.set('fieldLabels', {'Nombre': 'inline label - always visible', 'Categoria': 'inline label - always visible', });
lyr_Ferrocarril_6.set('fieldLabels', {'fid': 'hidden field', '名前': 'inline label - always visible', 'Nombre': 'inline label - always visible', 'Tipo': 'inline label - always visible', });
lyr_Rutas_7.set('fieldLabels', {'fid': 'hidden field', '名前': 'inline label - always visible', 'Nombre': 'inline label - always visible', });
